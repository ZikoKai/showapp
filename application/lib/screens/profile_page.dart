  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 29, 99, 145),
      ),
      body: _pages[_selectedIndex],
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: _selectedIndex,
        onTap: _onItemTapped,
        selectedItemColor: const Color.fromARGB(255, 29, 99, 145),
...
class _ProfileViewState extends State<ProfileView> {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          const CircleAvatar(
            radius: 60,
            backgroundColor: Color.fromARGB(255, 29, 99, 145),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 29, 99, 145).withOpacity(0.1),
  ...
  Widget profileItem(IconData icon, String title, VoidCallback onTap) {
    return ListTile(
      leading: Icon(icon, color: const Color.fromARGB(255, 29, 99, 145)),
      title: Text(title),
